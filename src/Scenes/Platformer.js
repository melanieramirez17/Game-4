    class Platformer extends Phaser.Scene {
        ...
        create() {
            ...
            this.map = this.add.tilemap("platformer-game-level-1", 18, 18, 45, 25);
            ...
            this.levelText = this.add.text(5, 17, "Level 1", {
                fontSize: '12px',
                fontFamily: 'Arial',
                fill: '#000000',
            });
            ...
            this.arrowText = this.add.text(1980, 150, "---->", {
                fontSize: '12px',
                fontFamily: 'Arial',
                fill: '#000000', 
            });
            this.arrowText.angle = 90;
